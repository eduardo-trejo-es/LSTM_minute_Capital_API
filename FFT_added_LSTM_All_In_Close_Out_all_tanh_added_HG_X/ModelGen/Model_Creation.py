...
LSTM_Layer2=keras.layers.LSTM(90, return_sequences=False,activation='tanh')(Dropout_layer2)

Dropout_layer3=keras.layers.Dropout(0.5)(LSTM_Layer2)# modify


#---------------------------Outputs
dense=keras.layers.Dense(1,activation='tanh')(Dropout_layer3)
...
model.save("FFT_added_LSTM_All_In_Close_Out_all_tanh_added_HG_X/ModelGen/Model/Model_LSTM_31_FFT_32_in_1_out_tanh_added")