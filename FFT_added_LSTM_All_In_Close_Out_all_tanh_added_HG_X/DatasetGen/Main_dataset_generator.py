...
if item_to_use==0 :
    ...
    MonthAddedPath="FFT_added_LSTM_All_In_Close_Out_all_tanh_added_HG_X/DatasetGen/CRUDE_OIL/CRUDE_OIL_Data_And_month.csv"
    yearAddedPath="FFT_added_LSTM_All_In_Close_Out_all_tanh_added_HG_X/DatasetGen/CRUDE_OIL/CRUDE_OIL_Data_And_year.csv"
    ...
    MonthAddedPath="FFT_added_LSTM_All_In_Close_Out_all_tanh_added_HG_X/DatasetGen/Copper_GH_F/Copper_Data_And_month.csv"
    yearAddedPath="FFT_added_LSTM_All_In_Close_Out_all_tanh_added_HG_X/DatasetGen/Copper_GH_F/Copper_Data_And_year.csv"
