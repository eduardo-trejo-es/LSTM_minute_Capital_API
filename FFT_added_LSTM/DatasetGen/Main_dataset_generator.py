...
#dataSet_Gen.AddColumnWeekDay("FFT_added_LSTM/DatasetGen/CRUDE_OIL/CRUDE_OIL_Data.csv", "FFT_added_LSTM/DatasetGen/CRUDE_OIL/CRUDE_OIL_Dataand_DayNum.csv",False)
...
inicialPath="FFT_added_LSTM/DatasetGen/CRUDE_OIL/CRUDE_OIL_Dataand_DayNum.csv"
FFTNew_FileData="FFT_added_LSTM/DatasetGen/CRUDE_OIL/CRUDE_OIL_Dataand_FFT_10_50_100.csv"
for i in Column:
    for j in frec:
