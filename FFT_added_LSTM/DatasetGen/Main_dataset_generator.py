...
dataSet_Gen.AddColumnWeekDay("FFT_added_LSTM/DatasetGen/CRUDE_OIL/CRUDE_OIL_Dataand_FFT_10_50_100.csv", "FFT_added_LSTM/DatasetGen/CRUDE_OIL/CRUDE_OIL_Dataand_FFT_10_50_100_DayNum.csv",False)
