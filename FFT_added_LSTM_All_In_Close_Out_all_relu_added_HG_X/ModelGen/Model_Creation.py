...
model.save("FFT_added_LSTM_All_In_Close_Out_all_relu_added_HG_X/ModelGen/Model/Models_fewColums/Model_LSTM_20BackDlastFFTCloseValum700FFT",save_format="h5")