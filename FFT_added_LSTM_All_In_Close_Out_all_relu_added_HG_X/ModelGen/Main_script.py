...
#training_result=trainer_model.to_train(2,100,Model_Path,Data_CSV,percentageData,5)
...
for i in datefiltredPercentage:
    ...
    forcaster.ToForcastfrom(2,str(i),Data_CSV,backdaysConsidered)
...
#if fft considered:
Allandforcast=all_df[locpercentage-backdaysConsideredToBForcasted+backdaysConsidered:locpercentage+5]
#if not FFT consider
