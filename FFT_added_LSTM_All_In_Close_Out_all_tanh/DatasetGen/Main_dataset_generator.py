...
inicialPath="FFT_added_LSTM_All_In_Close_Out_all_tanh/DatasetGen/CRUDE_OIL/CRUDE_OIL_Data_And_year.csv"
FFTNew_FileData="FFT_added_LSTM_All_In_Close_Out_all_tanh/DatasetGen/CRUDE_OIL/CRUDE_OIL_Dataand_FFT_10_50_100.csv"
for i in Column:
    for j in frec:
