...
LSTM_Layer2=keras.layers.LSTM(1000, return_sequences=False,activation='relu')(Dropout_layer2)
...
model.save("FFT_added_LSTM_All_In_Close_Amazon_Out_all_relu_added_HG_X/ModelGen/Model/Model_LSTM_AMZN_31_FFT_32_in_1_out_tanh_added")